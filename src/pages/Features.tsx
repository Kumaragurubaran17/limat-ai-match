    ...
    <Layout>
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="absolute inset-0 bg-gradient-to-bl from-blue-500/10 via-purple-500/10 to-pink-500/10 animate-gradient-slow"></div>
        </div>
        ...
        <div className="container mx-auto py-10 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {featureGroups.map((group, index) => (
              <Card key={index} className="overflow-hidden backdrop-blur-sm bg-white/50 dark:bg-black/50 border-0 shadow-lg transform transition-all hover:shadow-xl">
