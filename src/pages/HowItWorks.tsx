...
import { CircleHelp, BookOpen, Layers, Settings } from "lucide-react";
    ...
    <Layout>
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/10 via-purple-500/10 to-pink-500/10 animate-gradient-slow"></div>
        </div>
        
        <div className="container mx-auto py-10 relative z-10">
          <h1 className="text-4xl font-bold mb-8 text-center flex items-center justify-center">
            <CircleHelp className="mr-2" /> How LIMAT Works
          </h1>
          ...
          <div className="grid grid-cols-1 gap-8">
            <div className="relative">
              ...
              <div className="ml-16 mb-12 relative">
                ...
                <Card className="p-6 backdrop-blur-sm bg-white/50 dark:bg-black/50 border-0 shadow-lg transform transition-transform hover:scale-[1.01]">
                  <CardContent className="p-0">
                    <h2 className="text-2xl font-bold mb-4 flex items-center">
                      <BookOpen className="mr-2 text-blue-600" /> Resume Screening
                    </h2>
                    <p className="mb-4">
              ...
              <div className="ml-16 mb-12 relative">
                ...
                <Card className="p-6 backdrop-blur-sm bg-white/50 dark:bg-black/50 border-0 shadow-lg transform transition-transform hover:scale-[1.01]">
                  <CardContent className="p-0">
                    <h2 className="text-2xl font-bold mb-4 flex items-center">
                      <Layers className="mr-2 text-blue-600" /> AI Interviewer
                    </h2>
                    <p className="mb-4">
              ...
              <div className="ml-16 mb-12 relative">
                ...
                <Card className="p-6 backdrop-blur-sm bg-white/50 dark:bg-black/50 border-0 shadow-lg transform transition-transform hover:scale-[1.01]">
                  <CardContent className="p-0">
                    <h2 className="text-2xl font-bold mb-4 flex items-center">
                      <Settings className="mr-2 text-blue-600" /> Role-Specific Assessment
                    </h2>
                    <p className="mb-4">
              ...
              <div className="ml-16 relative">
                ...
                <Card className="p-6 backdrop-blur-sm bg-white/50 dark:bg-black/50 border-0 shadow-lg transform transition-transform hover:scale-[1.01]">
                  <CardContent className="p-0">
                    <h2 className="text-2xl font-bold mb-4 flex items-center">
                      <Settings className="mr-2 text-blue-600" /> Decision Support System
                    </h2>
                    <p className="mb-4">
